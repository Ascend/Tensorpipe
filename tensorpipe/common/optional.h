...
template <class T>
using OptionalBase = typename std::conditional<std::is_trivially_destructible<T>::value, // if possible
...
namespace std {
template <typename T>
struct hash<tensorpipe_npu::optional<T>> {
  typedef typename hash<T>::result_type result_type;
  typedef tensorpipe_npu::optional<T> argument_type;

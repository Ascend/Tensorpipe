...
aclError aclrtMemsetAsync(void *devPtr,        size_t maxCount, int32_t value, size_t count, aclrtStream stream){return 0;}
aclError aclrtMemset(void *devPtr, size_t maxCount, int32_t value, size_t count){return 0;}
